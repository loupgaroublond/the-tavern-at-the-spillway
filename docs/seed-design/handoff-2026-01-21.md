...
xcodebuild -project Tavern.xcodeproj -scheme Tavern build -derivedDataPath .build/xcodebuild && open .build/xcodebuild/Build/Products/Debug/Tavern.app

# Kill existing and restart (for iteration)
pkill -f "Tavern.app" 2>/dev/null; open .build/xcodebuild/Build/Products/Debug/Tavern.app
```
