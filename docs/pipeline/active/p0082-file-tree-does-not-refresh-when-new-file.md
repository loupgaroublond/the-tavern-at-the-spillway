---
id: p0082
slug: file-tree-does-not-refresh-when-new-file
title: "File tree does not refresh when new files appear on disk"
phase: 1-design
gate: pending
priority: 2
source-bead: jake-hnb
child-beads: []
blocked-by: []
...
# File tree does not refresh when new files appear on disk

## Brief
> Migrated from bead jake-hnb (bug, priority 2). Stub — needs design before implementation.
