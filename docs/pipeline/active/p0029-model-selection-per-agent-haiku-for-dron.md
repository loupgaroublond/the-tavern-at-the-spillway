---
id: p0029
slug: model-selection-per-agent-haiku-for-dron
title: "Model selection per agent — Haiku for drones, Sonnet for coordinators, Opus for architects"
phase: 1-design
gate: pending
priority: 3
source-bead: jake-kaq
child-beads: []
blocked-by: []
...
# Model selection per agent — Haiku for drones, Sonnet for coordinators, Opus for architects

## Brief
> Migrated from bead jake-kaq (feature, priority 3). Stub — needs design before implementation.
...
Key questions: How does ClodeMonster SDK support model selection? Does model affect token budget? Can model be changed mid-session? What are the cost tradeoffs?
